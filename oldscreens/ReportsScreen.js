...
export default class ReportsScreen extends React.Component { 
 constructor(props) {
	...
	this.props.navigation.setParams({goBack: () => {this.state.notSent = true; this.props.navigation.goBack()}});
  ...
  sendData = () => {
	  ...
	  if(this.webview !== null){
	   ...
	   //let rrrun = `let xxx = ${JSON.stringify(this.dt)}; true;`;
	   //this.webview.injectJavaScript(rrrun);
	   this.state.notSent = false;
	  }
  }
